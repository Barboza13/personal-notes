    ...
    <template #default>
      <section class="flex justify-around items-center h-1/12 w-full bg-(--default-background) text-(--text-color) border-b border-b-gray-500 p-2">
        ...
        <div class="flex justify-center items-center h-full w-1/2 gap-2">
          ...
          <button class="bg-red-500 hover:bg-red-600 rounded-md cursor-pointer transition-colors duration-75 ease-in py-1 px-2" @click="isOpenDeleteModal = true">
            <v-icon name="md-delete" title="Eliminar" />
          </button>
        </div>
      </section>
